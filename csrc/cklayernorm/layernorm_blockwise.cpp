...
void modmain(Launch_params<lnck_fprop_params> &launch_params)
{
    ...
    ck::index_t M      = launch_params.params.rows;
    ck::index_t N      = launch_params.params.cols;
    ck::index_t Stride = N;
    ...
    auto argument_ptr    = device_instance.MakeArgumentPointer(
        ...
        {N, 1},
        {1},
        launch_params.params.epsilon,
        launch_params.params.x_ptr,
        launch_params.params.gamma_ptr,
        launch_params.params.beta_ptr,
        launch_params.params.z_ptr,
        nullptr,
        nullptr,
        PassThrough{});
